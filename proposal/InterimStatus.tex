...
\begin{table}[!h]
\renewcommand{\arraystretch}{1}
\caption{Measurements for Ant: Structural and Logical}
...
\begin{table}[!h]
\renewcommand{\arraystretch}{1}
\caption{Measurements for Hibernate: Structural and Logical}
...
\begin{table}[!h]
\renewcommand{\arraystretch}{1}
\caption{Measurements for Tomcat Catalina: Structural and Logical}
