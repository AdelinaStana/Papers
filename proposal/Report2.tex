...
The precision-recall metric is suited if the threshold value is fixed. If the threshold value variable, then metrics that capture the behavior over all possible values must be used. Such metric is the Receiver Operating Characteristic metric.
