...
\noindent\fbox{%
    \parbox{\textwidth}{%
      \textit{Null hypothesis:} Key classes detection is better when we provide both types of dependencies as input to the tool. The output has a higher ROC-AUC score than the base approach.
     
     \textit{Alternative Hypothesis:} Key classes detection is worse when we provide both types of dependencies as input to the tool. The output has a lower ROC-AUC score than the base approach.
...
\noindent\fbox{%
    \parbox{\textwidth}{%
      \textit{Null hypothesis:} The output has a ROC-AUC score between 0.5 and 1. 
     
     \textit{Alternative Hypothesis:} The output has a ROC-AUC score between 0 and 0.5. 
