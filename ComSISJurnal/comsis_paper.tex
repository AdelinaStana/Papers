...
Sora et al. use the static analysis of the source code, a page ranking algorithm and other class attributes to finding key classes \cite{PagerankENASE}, \cite{enase15}, \cite{SoraSpringer}, \cite{PagerankSACI},\cite{Finding-key-classes}.
