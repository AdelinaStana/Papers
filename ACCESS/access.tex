...
\begin{tabular}{|c|l|}
\hline
\textbf{Weight} & \textbf{Dependency categories} \\ \hline
4 & Interface realization \\ \hline
3 & Inheritance, parameter, return type, field, cast, type binding \\ \hline
2 & Method call, field access, instantiation \\ \hline
1 & Local variable \\ \hline
\end{tabular}
...
\subsection{Experiment on weights}
...
\textbf{LD(100)} & 33.93 & 37.04 & 12.00 & 43.00 \\
 \hline
\end{tabular}
\caption{Average weights of Structural Dependencies (SD) and Logical Dependencies (LD) across different thresholds for the systems.}
\end{table}
...
\cline{4-12}
\textbf{Factor} & \textbf{SD} & \textbf{LD} & \textbf{Clusters} & \textbf{MQ} & \textbf{Mojo FM} & \textbf{Clusters} & \textbf{MQ} & \textbf{Mojo FM} & \textbf{Clusters} & \textbf{MQ} & \textbf{Mojo FM} \\
\hline
...
\hline
\end{tabular}
\caption{Comparison of different clustering methods for multiplication factors applied for LD(100)}
\end{table*}
