...
\begin{itemize}
    ...
    \item \textbf{MoJoFM}: Move and Join Effectiveness Measure Metric
\end{itemize}
...
Details on how structural dependencies are extracted using a tool from previous research.
\subsubsection{Weighting Structural Dependencies}
Discussion on how different types of structural dependencies are weighted.
\begin{table}[htbp]
\centering
\begin{tabular}{|c|l|}
\hline
...
1 & Local variable \\ 
 \hline
\end{tabular}
\caption{Weights assigned to different structural dependency types.}
\end{table}
...
\subsection{Comparison and Combination of Dependencies}
