...
Our work investigates filtering techniques to eliminate co-change situations that are not meaningful as logical dependencies. The effectiveness of these filtering techniques is validated by using the obtained logical dependencies in architectural reconstruction, a reverse engineering activity aimed at recovering a system's modular structure.
...
The works of Zimmermann et al. \cite{Zimmermann:2004:MVH:998675.999460, b7} and  Capiluppi et al. \cite{b1, b12017} introduced the idea that co-changes must be filtered before considering them as dependencies. Different filtering techniques have been empirically proposed. Also, the filtered logical dependencies have been used in other types of applications, not just software architecture reconstruction.
...
In addition to our per-system analysis, we perform a cross-system comparison to evaluate the impact of different dependency input configurations. Out of all the strength thresholds used in our experiments, we selected a set of representative configurations for cross-system comparison against the \textit{SD-only} baseline.

We included the following configurations:

\begin{itemize}
    \item \textit{SD}
    \item \textit{SD+LD(10)}, \textit{SD+LD(20)}, \textit{SD+LD(30)}, \textit{SD+LD(40)}. These four combinations were selected because, at the level of individual systems, the best results were typically observed within the [10--40\%] threshold range. 
    \item \textit{LD(10)}, \textit{LD(20)}, \textit{LD(30)}, \textit{LD(40)}. These thresholds were chosen to match the same [10--40] range as the combinations and because the coverage of logical dependencies remains reasonable at these thresholds.
    \item \textit{LD(100)}. This configuration was included because it produced the highest metric results in many cases.
\end{itemize}

To statistically support the comparison, we used the Kruskal-Wallis test~\cite{kruskal}, a non-parametric method for comparing more than two groups. This test was appropriate in our case because we evaluated the same systems under ten distinct input configurations. Each group contains four values, one for each system.
The Kruskal-Wallis test compares the distributions of multiple groups based on ranked data and returns a test statistic and a p-value. The p-value indicates whether the differences between the groups are statistically significant. A p-value below 0.05 is generally interpreted as a statistically significant difference between groups.


Tables~\ref{tab:combined_mq_extended} and \ref{tab:combined_mojofm_extended} present the average MQ and MoJoFM scores for each input configuration, grouped by clustering algorithm. The results show that configurations involving logical dependencies, alone or in combination with structural dependencies, outperform the SD-only baseline. The Kruskal-Wallis test shows statistically significant differences for all clustering methods on MQ, and for Louvain and Leiden on MoJoFM.

\begin{table*}[htbp]
\centering
\caption{Average MQ scores across all systems for different input configurations and Kruskal test results.}
\label{tab:combined_mq_extended}
\begin{tabular}{|l|c|cccc|ccccc|c|}
\hline
\multirow{2}{*}{\textbf{Clustering}} & \multirow{2}{*}{\textbf{SD}} 
& \multicolumn{4}{c|}{\textbf{SD+LD}} 
& \multicolumn{5}{c|}{\textbf{LD only}} 
& \multirow{2}{*}{\boldmath$\chi^2$ / p} \\
\cline{3-11}
& & (10) & (20) & (30) & (40) & (10) & (20) & (30) & (40) & (100) & \\
\hline
Louvain & 0.1323 & 0.2730 & 0.2475 & 0.2440 & 0.2728 & 0.4913 & 0.5072 & 0.5035 & 0.5555 & 0.5912 & 30.59 / <0.001 \\
Leiden  & 0.1213 & 0.2485 & 0.2665 & 0.2423 & 0.2708 & 0.4933 & 0.5072 & 0.5035 & 0.5545 & 0.5912 & 30.71 / <0.001 \\
DBSCAN  & 0.1352 & 0.1502 & 0.1522 & 0.1598 & 0.1532 & 0.4055 & 0.4790 & 0.5325 & 0.5420 & 0.6268 & 29.87 / <0.001 \\
\hline
\end{tabular}
\end{table*}
...
\begin{table*}[htbp]
\centering
\caption{Average MoJoFM scores across all systems for different input configurations and Kruskal test results.}
\label{tab:combined_mojofm_extended}
\begin{tabular}{|l|c|cccc|ccccc|c|}
\hline
\multirow{2}{*}{\textbf{Clustering}} & \multirow{2}{*}{\textbf{SD}} 
& \multicolumn{4}{c|}{\textbf{SD+LD}} 
...
& & (10) & (20) & (30) & (40) & (10) & (20) & (30) & (40) & (100) & \\
\hline
Louvain & 57.37 & 63.11 & 61.21 & 62.56 & 61.97 & 64.33 & 65.80 & 66.91 & 68.62 & 71.61 & 6.79 / 0.034 \\
Leiden  & 59.59 & 62.65 & 62.86 & 61.62 & 62.17 & 64.15 & 65.55 & 67.06 & 68.84 & 71.61 & 6.08 / 0.048 \\
DBSCAN  & 49.15 & 52.50 & 50.29 & 50.84 & 50.87 & 58.25 & 62.27 & 65.61 & 68.34 & 61.03 & 4.45 / 0.108 \\
\hline
\end{tabular}
\end{table*}
...
\bibitem{kruskal} Kruskal, William H., and W. Allen Wallis. “Use of Ranks in One-Criterion Variance Analysis.” \textit{Journal of the American Statistical Association} 47, no. 260 (1952): 583–621.
