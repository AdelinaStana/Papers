...
\begin{table}[htbp]
\centering
\caption{Average MQ scores across all systems for different input configurations and Friedman test results.}
\label{tab:combined_mq}
\begin{tabular}{|l|c|c|c|c|}
\hline
\textbf{Clustering} & \textbf{SD} & \textbf{SD+LD(20)} & \textbf{LD(100)} & \boldmath$\chi^2$ / p \\
\hline
Louvain & 0.132 & 0.247 & 0.591 & 8.00 / 0.018 \\
Leiden  & 0.121 & 0.267 & 0.591 & 8.00 / 0.018 \\
DBSCAN  & 0.135 & 0.152 & 0.627 & 8.00 / 0.018 \\
\hline
\end{tabular}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Average MoJoFM scores across all systems for different input configurations and Friedman test results.}
\label{tab:combined_mojofm}
\begin{tabular}{|l|c|c|c|c|}
\hline
\textbf{Clustering} & \textbf{SD} & \textbf{SD+LD(20)} & \textbf{LD(100)} & \boldmath$\chi^2$ / p\\
\hline
Louvain & 57.37 & 61.21 & 71.61 & 6.50 / 0.039 \\
Leiden  & 59.59 & 62.86 & 71.61 & 6.50 / 0.039 \\
DBSCAN  & 49.15 & 50.29 & 61.03 & 2.80 / 0.247 \\
\hline
\end{tabular}
\end{table}
