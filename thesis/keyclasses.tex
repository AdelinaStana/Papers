...
\noindent\fbox{%
    \parbox{\textwidth}{%
      \textit{Hypothesis:} Key class detection is better when both types of dependencies are provided as input to the tool. The output has a higher ROC-AUC score than the base approach.
    }%
}
\medskip
